        ...
        <>
            <div className="project-page-container">
                ...
                <div className="image-container">
                    <img src="/images/Project_Images/QAChatbot/message_flow_diagram.svg" alt="End-to-end message flow diagram" className="project-images-large" />
                </div>
                ...
                <div className="image-container">
                    <img src="/images/Project_Images/QAChatbot/prompt_assembly_diagram.svg" alt="Prompt assembly pipeline diagram" className="project-images-large" />
                </div>
                ...
                <div className="image-container">
                    <img src="/images/Project_Images/QAChatbot/vanna_text2sql_diagram.svg" alt="Vanna Text-to-SQL pipeline diagram" className="project-images-large" />
                </div>
                ...
                <div className="image-container">
                    <img src="/images/Project_Images/QAChatbot/web_search_diagram.svg" alt="Web Search RAG pipeline diagram" className="project-images-large" />
                </div>
